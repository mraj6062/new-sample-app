...
docker:
	docker build \
		...
		-t edgexfoundry/new-sample-app:$(GIT_SHA) \
		-t edgexfoundry/new-sample-app:${APPVERSION}-dev \
		-t nexus3.edgexfoundry.org:10004/new-sample-app:${APPVERSION}-dev \
		.
